...
<main>
  ...
  <div class="front front-hero">
    ...
    <img src="<?php echo (get_theme_file_uri('/assets/images/errorCat.png')); ?>" alt="hero-image">
  ...
  <div class="front front-kitchen">
    ...
    <a href="<?php echo (get_post_type_archive_link('kitchenware')); ?>">
      <img src="<?php echo (get_theme_file_uri('/assets/images/errorCat.png')); ?>" alt="Kitchenware">
    </a>
  ...
  <div class="front front-community">
    ...
    <a href="<?php echo (get_post_type_archive_link('communitypost')); ?>">
      <img src="<?php echo (get_theme_file_uri('/assets/images/errorCat.png')); ?>" alt="Community">
    </a>
